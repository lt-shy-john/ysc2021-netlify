...
if ( ! class_exists( 'One_Page_Conference_Slider_Control' ) ) {
	...
	class One_Page_Conference_Slider_Control extends Wp_Customize_Control {
        ...
        public function enqueue() {            
            wp_enqueue_style( 'one-page-conference-slider', WEP_EVENT_URL . '/admin/includes/custom-controls/slider/slider.css', null );
            wp_enqueue_script( 'one-page-conference-slider', WEP_EVENT_URL . '/admin/includes/custom-controls/slider/slider.js', array( 'jquery' ), false, true ); //for slider
        }
