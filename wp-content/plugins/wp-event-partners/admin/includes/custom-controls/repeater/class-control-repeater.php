    					...
    					<# _.each( data, function( field, i ) { #>
    						...
    						<div class="repeater-field repeater-field-{{{ field.type }}}">
    							...
    							<# } else if ( field.type === 'image' || field.type === 'cropped_image' ) { #>
    								...
    								<figure class="one-page-conference-image-attachment" data-placeholder="<?php echo esc_attr( 'No Image Selected', 'theme-slug' ); ?>" >
    									<# if ( field.default ) { #>
    							...
    							<# } else if ( field.type === 'upload' ) { #>
    								...
    								<figure class="one-page-conference-file-attachment" data-placeholder="<?php echo esc_attr( 'No File Selected', 'theme-slug' ); ?>" >
    									<# if ( field.default ) { #>
