<?php
if( ! class_exists( 'Wep_Showcase_Taxonomy_Images' ) ) {
  class Wep_Showcase_Taxonomy_Images {
    ...
    public function init() {
     // Image actions
     add_action( 'room_add_form_fields', array( $this, 'add_category_image' ), 10, 2 );
     add_action( 'created_room', array( $this, 'save_category_image' ), 10, 2 );
     add_action( 'room_edit_form_fields', array( $this, 'update_category_image' ), 10, 2 );
     add_action( 'edited_room', array( $this, 'updated_category_image' ), 10, 2 );
     add_action( 'admin_enqueue_scripts', array( $this, 'load_media' ) );
     add_action( 'admin_footer', array( $this, 'add_script' ) );
   }

   public function load_media() {
     if( ! isset( $_GET['taxonomy'] ) || $_GET['taxonomy'] != 'room' ) {
       return;
     }
     wp_enqueue_media();
   }
   ...
   public function add_category_image( $taxonomy ) { ?>
     <div class="form-field term-group">
       ...
       <p>
         <input type="button" class="button button-secondary show_media_button" id="show_media_button" name="show_media_button" value="<?php _e( 'Add Image', 'showcase' ); ?>" />
   ...
   public function add_script() {
     ...
     <script> jQuery(document).ready( function($) {
       ...
       ct_media_upload('.show_media_button.button');
...
$Wep_Showcase_Taxonomy_Images = new Wep_Showcase_Taxonomy_Images();
$Wep_Showcase_Taxonomy_Images->init(); }