...
<div class="single-post">
    ...
    <div class="post-content">
        ...
        <div class="bottom-info">
            <a href="<?php the_permalink(); ?>" rel="bookmark" title="" class="btn btn-primary pull-left"><?php esc_html_e('Read More','one-page-conference'); ?> <i class="fa fa-angle-double-right"></i></a>
