...
<div id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
    ...
    <div class="summary">
            ...
            <div class="info">
              <ul class="list-inline">
                ...
                <?php if( in_array( 'number_of_comments', $post_details ) ) { ?>
                  <li><i class="fa fa-comments-o"></i> <?php comments_popup_link( __( 'zero comment', 'one-page-conference' ), __( 'one comment', 'one-page-conference' ), __( '% comments', 'one-page-conference' ) ); ?></li>
                <?php } ?>
        ...
        <?php echo one_page_conference_excerpt( 20 ); ?>
        
        <a href="<?php echo esc_url( get_permalink() ); ?>" rel="bookmark" title="" class="readmore"><?php esc_html_e('Read More','one-page-conference'); ?> </a>
