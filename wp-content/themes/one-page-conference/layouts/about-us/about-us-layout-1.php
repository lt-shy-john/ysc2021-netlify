...
if(!empty($aboutPage)):
    ...
    <section class="home-section about-layout-1" id="about">
        <div class="container">
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-6">
                        <div class="about-content">
                            ...
                            <?php the_excerpt(); ?>
                            <a class="btn btn-secondary" href="<?php esc_url(the_permalink( $aboutPage ));?>"><?php esc_html_e( 'Read More', 'one-page-conference' ); ?></a>
                        </div>
                    </div>
                </div>
            </div>
