...
class CaptchaService {
	 ...
	 * @since   1.0.0
	 */
	public function send_event_to_api( $event_type, $client_ips, $origin, $event_meta = array() ) {
		return $this->captcha_api_client->send_event_type( $event_type, $client_ips, $origin, $event_meta );
	}
