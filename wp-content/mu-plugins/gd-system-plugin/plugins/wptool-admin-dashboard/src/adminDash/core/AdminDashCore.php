...
class AdminDashCore {
	...
	*/
	...
	function admin_menu() {
		...
		$menu_title = isset( $data['menu_title'] ) ? $data['menu_title'] : WhitelabelConstants::RESELLER;
	...
	private function whitelabel_data() {
		...
		$data               = array();
		$data['logo']       = '';
		$data['menu_title'] = WhitelabelConstants::RESELLER;
	...
	function admin_style() {
		...
		if ( array_key_exists( 'page', $_GET ) ) {
			if ( PageConstants::PAGE_NAME === $_GET['page'] ) {
	...
	function admin_script() {
		...
		wp_localize_script(
			...
			array(
				'root'      => $root_url,
				'root_type' => str_contains( $root_url, 'wp-json' ) ? APIConstants::WP_JSON_URL : APIConstants::REST_ROUTE_URL,
