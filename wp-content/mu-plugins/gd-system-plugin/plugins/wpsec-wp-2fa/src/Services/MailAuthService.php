...
class MailAuthService {
	...
	private function get_default_mail_message() {
		return __( "Your one-time code is: [code]. \n Site: [site-url] \n Please verify you're really you by entering this 6-digit \n code when you sign in. Just a heads up, this code will \n expire in 15 minutes for security reasons.", 'wpsec-wp-2fa' );
	}
