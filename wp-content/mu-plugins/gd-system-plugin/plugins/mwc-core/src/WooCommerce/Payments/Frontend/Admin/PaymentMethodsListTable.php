...
class PaymentMethodsListTable
{
    ...
    public function enqueueScripts() : void
    {
        ...
        if (PoyntOnboarding::STATUS_CONNECTED === $onboardingStatus) {
            $paymentMethods[] = [
                ...
                'status'      => $onboardingStatus,
                'allowButton' => ! ArrayHelper::contains([PoyntOnboarding::STATUS_SUSPENDED, PoyntOnboarding::STATUS_PENDING, PoyntOnboarding::STATUS_TERMINATED], $onboardingStatus),
    ...
    public function renderOnboardingStatusCell($gateway)
    {
        ...
        <td class="<?php echo esc_attr(static::$onboardingStatusColumnName); ?>" width="1%">
            <?php
            if ($gateway instanceof GoDaddyPaymentsGateway || $gateway  instanceof ApplePayGateway || $gateway instanceof GoDaddyPayInPersonGateway) {
