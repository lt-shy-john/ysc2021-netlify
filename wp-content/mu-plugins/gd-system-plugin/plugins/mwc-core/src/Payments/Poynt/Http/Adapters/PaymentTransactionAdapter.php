...
class PaymentTransactionAdapter implements DataSourceAdapterContract
{
    ...
    public function convertFromSource() : ChargeRequest
    {
        ...
        $cardField = $this->source->getSource() === 'mwc_payments_apple_pay' ? 'nonce' : 'cardToken';
    ...
    public function convertToSource(Response $response = null) : PaymentTransaction
    {
        ...
        if ('CREDIT_DEBIT' === ArrayHelper::get($responseBody, 'fundingSource.type') && (! $this->source->getPaymentMethod() || 'APPLE_PAY' === ArrayHelper::get($responseBody, 'fundingSource.card.source'))) {
