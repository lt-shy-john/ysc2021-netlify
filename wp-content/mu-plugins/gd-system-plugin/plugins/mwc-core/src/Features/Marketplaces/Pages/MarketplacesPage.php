...
class MarketplacesPage extends AbstractAdminPage implements ComponentContract
{
    ...
    {
        foreach (ChannelRepository::getConnected() as $channel) {?>
    ...
    {
        ?>
        <a href="<?php echo esc_url(Marketplaces::getMarketplacesUrl('/settings/channels')); ?>" target="_blank" class="button button-primary"><?php esc_html_e('Add Sales Channel', 'mwc-core'); ?></a>
        <?php
    }
