...
final class Bundled_Plugins {
	...
	public function __construct() {
		...
		$bundled_plugins = [
			...
			'wpsec-wp-cp/init.php'              => Plugin::is_site_created_after( 1655683200 ) || Plugin::is_site_in_percentage( 40, null, 1655683200 ), // 06.20.2022 00:00:00 GMT + 40% before that date
			'wptool-admin-dashboard/init.php'   => get_option('admin_dash_enabled','disabled') === 'enabled' || Plugin::is_site_created_after( 1664755200 ) || Plugin::is_site_in_percentage( 40, null, 1664755200 ), // 10.03.2022 00:00:00 GMT + 40% before that date
			'wpsec-wp-2fa/init.php'             => true,
		];
